  ...
  return (
    <div className="relative px-4 py-16 sm:px-6 lg:px-8">
      ...
      <footer className="mt-8 mb-2 prose prose-lg text-gray-500 max-w-[365px] space-x-2">
        <a href="javascript:void(0);" className="inline-block fill-current p-1.5 rounded-lg hover:text-gray-600 duration-300 bg-gray-200/0 w-10 hover:bg-gray-200/100">
